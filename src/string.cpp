...
std::string& String::replace(std::string& str, char replaced, char sub){
	size_t idx = str.find(replaced);
	if (idx == std::string::npos) return str;
	return str.replace(idx, 1, 1, sub);
}

std::string& String::replace_all(std::string& str, const std::string& replaced, const std::string& sub){
...
std::string& String::replace_all(std::string& str, char replaced, char sub){
	size_t idx = std::string::npos;
	while((idx = str.rfind(replaced, idx)) != std::string::npos){
